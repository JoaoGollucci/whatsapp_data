...
INSERT INTO `gauge-prod.projeto_meli.gold_messages`
with base as (
select distinct
id,
date,
...
when lower(body) like '%meli.la%' or lower(caption) like '%meli.la%' then 'MERCADO LIVRE'
...
when lower(body) like '%kabum.com.br%' or lower(caption) like '%kabum.com.br%' then 'KABUM'
when lower(body) like '%cm-KABUM%' or lower(caption) like '%cm-KABUM%' then 'KABUM'
when lower(body) like '%ofertou.ai%terabyte%' or lower(caption) like '%ofertou.ai%terabyte%' then 'TERABYTE'
when lower(body) like '%cm-TERABYTE%' or lower(caption) like '%cm-TERABYTE%' then 'TERABYTE'
...
when lower(body) like '%.garnier.%' or lower(caption) like '%.garnier.%' then 'GARNIER'
when lower(body) like '%caffeinearmy.com.br%' or lower(caption) like '%caffeinearmy.com.br%' then 'CAFFEINE ARMY'
...
when lower(body) like '%pega.la%' or lower(caption) like '%pega.la%' then 'AGREGADOR'
when lower(body) like '%link.descontinhodemamae.com%' or lower(caption) like '%link.descontinhodemamae.com%' then 'AGREGADOR'
when lower(body) like '%enxovalbebe.com.br%' or lower(caption) like '%enxovalbebe.com.br%' then 'AGREGADOR'
when lower(body) like '%hidratei.com.br%' or lower(caption) like '%hidratei.com.br%' then 'AGREGADOR'
when lower(body) like '%encurtou.com%' or lower(caption) like '%encurtou.com%' then 'AGREGADOR'
when lower(body) like '%dicasdeofertaseachadinhos.com.br%' or lower(caption) like '%dicasdeofertaseachadinhos.com.br%' then 'AGREGADOR'
when lower(body) like '%tenis.cc%' or lower(caption) like '%tenis.cc%' then 'AGREGADOR'
when lower(body) like '%canalte.ch%' or lower(caption) like '%canalte.ch%' then 'AGREGADOR'
when lower(body) like '%ofertou.xyz%' or lower(caption) like '%ofertou.xyz%' then 'AGREGADOR'
when lower(body) like '%mulherestilosa.meucupom.me%' or lower(caption) like '%mulherestilosa.meucupom.me%' then 'AGREGADOR'
when lower(body) like '%ofertafitbr.com.br%' or lower(caption) like '%ofertafitbr.com.br%' then 'AGREGADOR'
when lower(body) like '%ritualdoskincare.com.br%' or lower(caption) like '%ritualdoskincare.com.br%' then 'AGREGADOR'
when lower(body) like '%indiqueidescontoss.com.br%' or lower(caption) like '%indiqueidescontoss.com.br%' then 'AGREGADOR'
-- BETS
...
with batch_fill as (
	...
	AND DATE(DATETIME(TIMESTAMP_SECONDS(timestamp), "America/Sao_Paulo")) = '2026-02-22')
	select
	id,
	date,
	time,
